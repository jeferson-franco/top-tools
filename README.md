...
Uma extensão do VS Code para gerar uma mensagem de confirmação inteligente com base nas alterações do arquivo
...
Utilize a API OpenAI dentro do VS Code

![Code GPT](https://user-images.githubusercontent.com/6216945/210677720-4a2ebbf3-84a1-4972-83a0-10a265c368ab.gif)
...
A superpotência de codificação moderna: plug-in gratuito de conclusão de código AI para seus idiomas favoritos. Digite menos. Codifique mais. Envie mais rápido.
...
Official Dracula Theme. A dark theme for VSCode.

//

Dracula Tema Oficial. Um tema escuro para VSCode.

![Dracula](https://raw.githubusercontent.com/dracula/visual-studio-code/master/screenshot.png)
...
Extensão do Visual Studio Code que aprimora a exibição de erros e avisos.
...
Visualize um gráfico do Git do seu repositório no Visual Studio Code e execute facilmente ações do Git a partir do gráfico.
...
Plug-in do Visual Studio Code para rastreamento automático de tempo e métricas geradas a partir de sua atividade de programação.
...
A secure and free password manager for all your devices.

//

Um gerenciador de senhas seguro e gratuito para todos os seus dispositivos.
...
### [LanguageTool](https://microsoftedge.microsoft.com/addons/detail/corretor-gramatical-e-ort/hfjadhjooeceemgojogkhlppanjkbobc)

Check for spelling and grammar problems in your texts anywhere on the web.

//

Verifique problemas de ortografia e gramática em seus textos em qualquer lugar da web.
...
Dark theme for all your sites. Keep your eyes relaxed by using the dark theme in your daily browsing.
...
O sistema de perguntas e respostas para a comunidade desenvolvedora.
...
Remova os avisos de cookies de quase todos os sites!
...
Finally, an efficient blocker. With low CPU and memory usage.

//

Finalmente, um bloqueador eficiente. Com baixo uso de memória e CPU.
...
Rastreamento de tempo automático para o Chrome.
